          ...
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <span class="text-grey">Web Designers & Developers</span><br />
                ...
                <v-btn tile dark class="text-blue mt-8" variant="outlined" text @click="scroll('contact')"  > Contact us</v-btn>
      ...
      <v-col cols="12" id="biog">
        <div class="hire">
          <v-row>
            ...
            <v-col cols="12" sm="4">
              <v-btn color="#2288f5" class="mt-15" text @click="scroll('contact')"  > Hire Us</v-btn>
